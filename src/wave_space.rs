...
mod tests {
    ...
    fn deposit_becomes_receive() {
        let csv = "DEPOSIT,2025-11-25 12:09:09,414f87aa-dc0b-40e4-a02f-7a3b156549c5,LIGHTNING_DEPOSIT,BTC,0,BTC,0.0009,wavecard topup";
    ...
    fn fee_becomes_fee_transaction() {
        let csv = "FEE,2025-12-20 11:03:25,94bc71dd-598b-4cbf-bb6e-85e5e8af6fc8,APPLICATION_FEE,BTC,0.00000586,BTC,0,payWaveLowValuePurchase Card Authorization at DirkHanten application fee of  0.00000586 BTC";
        let tx = parse_csv_row(csv);
    ...
    fn card_authorization_becomes_expense_with_value() {
        let csv = "TRANSACTION,2025-12-20 11:03:27,94bc71dd-598b-4cbf-bb6e-85e5e8af6fc8,CARD_AUTHORIZATION,BTC,0.00058554,EUR,43.85,";
        let tx = parse_csv_row(csv);
    ...
    fn fee_is_attached_when_transaction_id_matches() {
        let csv = concat!(
            ...
            "FEE,2025-12-20 11:03:25,94bc71dd-598b-4cbf-bb6e-85e5e8af6fc8,APPLICATION_FEE,BTC,0.00000586,BTC,0,fee memo\n",
            "TRANSACTION,2025-12-20 11:03:27,94bc71dd-598b-4cbf-bb6e-85e5e8af6fc8,CARD_AUTHORIZATION,BTC,0.00058554,EUR,43.85,\n",
        );
        let mut reader = csv::ReaderBuilder::new().from_reader(csv.as_bytes());
